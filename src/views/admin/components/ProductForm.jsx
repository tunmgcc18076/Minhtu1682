  ...
  const onSubmitForm = (form) => {
    if (imageFile.image.file || product.image) {
      onSubmit({
        ...
        image: imageFile?.image?.file ? imageFile.image.file : product.image,
        imageCollection: imageFile?.imageCollection ? imageFile.imageCollection : product.imageCollection
      });
    } else {
